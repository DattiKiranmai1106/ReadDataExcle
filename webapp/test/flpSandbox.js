		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comktsapexcelreaddataexcel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comktsapexcelreaddataexcel-display": {
								"semanticObject": "comktsapexcelreaddataexcel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kt.sap.excel.readdataexcel",
									"url": sap.ui.require.toUrl("com/kt/sap/excel/readdataexcel")
								}
							}
						}
					}
